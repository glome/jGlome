...
jQuery(function()
{
  ...
  jQuery(window)
    .on('hashchange', function()
    {
      ...
      // Toggle context page
      jQuery('[data-context="' + context + '"]').find('> .glome-full-width > .glome-content').not('[data-template="' + hash + '"]').addClass('hidden');
      jQuery('[data-context="' + context + '"]').find('> .glome-full-width > .glome-content').filter('[data-template="' + hash + '"]').removeClass('hidden');
